...
// Type: ImoSilverlightApp.UI.Views.MessageTemplates.MeAudioMessage
...
{
  public sealed class MeAudioMessage : Grid
  {
    internal Grid selfIconGrid;
    internal Ellipse ellipse;
    private bool _contentLoaded;

    public MeAudioMessage()
    {
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("/ImoSilverlightApp;component/UI/Views/MessageTemplates/MeAudioMessage.xaml", UriKind.Relative));
