...
// Type: ImoSilverlightApp.UI.Views.MessageTemplates.MeStickerMessage
...
{
  public sealed class MeStickerMessage : Grid
  {
    internal Grid selfIconGrid;
    internal Ellipse ellipse;
    private bool _contentLoaded;

    public MeStickerMessage()
    {
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("/ImoSilverlightApp;component/UI/Views/MessageTemplates/MeStickerMessage.xaml", UriKind.Relative));
